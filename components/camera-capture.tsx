...
export function CameraCapture({ onImageCapture }: CameraCaptureProps) {
  ...
  const handleConfirm = () => {
    if (capturedImage && selectedFile) {
      onImageCapture?.(capturedImage, selectedFile)
    }
  }
        ...
        {!capturedImage ? (
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <Button  type="button"  onClick={handleRetake} variant="outline" className="flex-1 border-gray-300">
                Reprendre
              </Button>
              <Button  type="button" onClick={handleConfirm} className="flex-1 bg-repair-blue hover:bg-repair-blue/90 text-white">
