...
//   // compteur de quota lu depuis les en-têtes X-RateLimit-*
...
//       // 👉 Lire les en-têtes de quota (même en cas d'erreur)
...
//       toast({
//         title: "Erreur",
//         description: error?.message || "Une erreur est survenue pendant l’analyse.",
//         variant: "destructive",
//       })
//     }
//   }
...
//           <div className="space-y-6">
//             {/* 🔔 Bandeau flashy si quota très bas */}
...
//                     {/* Petit compteur (après le premier appel on l'affiche) */}
//                     {quota && (
...
//                   {/* Afficher le compteur aussi sur l'écran de résultats */}
//                   {quota && (
